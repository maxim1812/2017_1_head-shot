...
class Mediator{
    ...
    constructor(){
        ...
        this.socketUrl = "http://maxim-socket-server-123.herokuapp.com/";
    ...
    addListenersToButtons() {
        ...
        gameWithAnotherPlayerBtn.addEventListener("click",function(){
            ...
            mediatorThis.twoPlayersMessage.setText("Ожидание соперника ...");
            ...
            mediatorThis.twoPlayersGameManager.startSendingRequestsForFindingEnemy();
        });
    }
}
